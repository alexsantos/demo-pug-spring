...
public class Segment extends AbstractMapper {

	// TODO ADD MAPPER DESCRIPTION
	private static final String MAPPER_DESCRIPTION = "";

	public Segment(MapperEngine engine, Message incomingMessage, Message outgoingMessage, Terser incomingTerser, Terser outgoingTerser, List<String> keys, String value) {
	...
	public void mapKey(String key) {
		try {
			// TODO VALIDATE THIS MAPPER BEHAVIOUR
			outgoingTerser.getSegment(key).parse(key);
